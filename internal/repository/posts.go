...
func (r *PostgresRepository) NewPost(login string, req entity.NewPostRequest) (entity.Post, error) {
...
func (r *PostgresRepository) GetPost(postId uuid.UUID) (entity.Post, error) {
	ctx, cancel := context.WithTimeout(context.Background(), operationTimeout)
	defer cancel()
...
func (r *PostgresRepository) ListPosts(login string, limit int, offset int) ([]entity.Post, error) {
	ctx, cancel := context.WithTimeout(context.Background(), operationTimeout)
	defer cancel()
...
func (r *PostgresRepository) LikePost(login string, postId uuid.UUID) (entity.Post, error) {
	ctx, cancel := context.WithTimeout(context.Background(), operationTimeout)
	defer cancel()
...
func (r *PostgresRepository) DislikePost(login string, postId uuid.UUID) (entity.Post, error) {
	ctx, cancel := context.WithTimeout(context.Background(), operationTimeout)
	defer cancel()
